...
public class LVL1  {
	...
	private static Timeline tl1 = new Timeline(new KeyFrame(Duration.millis(Home.getSpeed()),e -> gameloop()));
	...
	public static void gameloop() {
		...
		if(setup) {
			...
			smith.get(0).setFitHeight(60);
			smith.get(0).setFitWidth(60);
		...
		if(checkCollision()) {
			...
			smith.add(new ImageView(snake));
			smith.get(counter).setFitHeight(60);
			smith.get(counter).setFitWidth(60);
